		...
		case WM_COMMAND:
			switch(LOWORD(wParam)) {
				...
				case CM_FILE_EXIT:
					...
					break;
				case CM_ABOUT:
					MessageBox (NULL, "来自OLD HELPS的Windows文本编辑器\nhttps://oedit.github.io\nv0.0.1 Build(220927953)" , "关于", 0);
					break;
			}
			break;
		case WM_CLOSE:
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,LPSTR lpCmdLine, int nCmdShow) {
	...
	hwnd = CreateWindowEx(WS_EX_CLIENTEDGE,"WindowClass","OEdit",WS_OVERLAPPEDWINDOW,
		CW_USEDEFAULT,
		CW_USEDEFAULT,
		320,240,
